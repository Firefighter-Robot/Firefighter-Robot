...
#define LCD_INPUT_PINS		0x0F		//Zeros on the input pins of the LCD to be masked with the input
#define PORT_OUTPUT_PINS	0xF0	//ones on the output pins of the port to be masked with the output to the LCD


#define MOST_BIT_PIN	7			//used to shift right the LCD input if it is in the middle of the Port  specially in 4 bit mode
#define LEAST_BIT_PIN	4			//used to shift left the LCD input if it is in the middle of the Port specially in 4 bit mode
