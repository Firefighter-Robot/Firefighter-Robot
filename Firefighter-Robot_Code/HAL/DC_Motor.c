...
void Car_Routation(char angle , char direction)
{
	...
	if(direction == HAL_Car_TurnLeft)
	{
		...
		MCAL_TIMx_Set_Compare_Value(TIM2,_Duty_Cycle(10),Front_Left_Motor);

		MCAL_TIMx_Set_Compare_Value(TIM2,_Duty_Cycle(10),Back_Left_Motor);

		MCAL_TIMx_Set_Compare_Value(TIM2,_Duty_Cycle(10),Back_Right_Motor);
	...
	else if(direction == HAL_Car_TurnRight)
	{
		...
		MCAL_TIMx_Set_Compare_Value(TIM2,_Duty_Cycle(10),Front_Right_Motor);
